...
# Determine the column range for each process
...
for y in range(height):
    for x in range(width):
        ...
        local_convergence[x - start_col, y] = mandelbrot_set.convergence(c, smooth=True)
local_computation_time = time() - deb
...
if rank == 0:
    ...
    print(f"Temps total de calcul (parallèle) : {local_computation_time}")